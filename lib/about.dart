          ...
          child: Column(
            ...
            children: [
              ...
              TextButton.icon(onPressed: () async{
                var whatsappUrl ="whatsapp://send?phone=+996702777796";
                await canLaunch(whatsappUrl)? launch(whatsappUrl):print("whatsapp не установлен");
...
''',style: TextStyle(color: Colors.indigoAccent),),
              TextButton.icon(onPressed: () async {
                ...
                await canLaunch(instaUrl)? launch(instaUrl):print("instaUrl не установлен");
              }, icon: Image.asset('assets/images/launch.png',height: 60,), label: Text('Оцените приложение')),
            ],
          ),
        ),
      ),
